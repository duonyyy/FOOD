# Foodee Backend Overview

## 📖 Project Summary

**Foodee** is a backend service that powers a food‑ordering platform. It provides APIs for managing restaurants, menus, orders, payments, and real‑time job processing using **pg‑boss** (a PostgreSQL‑based job queue). The service is built with **Node.js**, **TypeScript**, and follows a modular, service‑oriented architecture.
