...
## Bài viết giới thiệu dự án Foodee:

   Description: Foodee – A scalable food ordering & delivery platform with hybrid REST + GraphQL API, real-time WebSocket, and AI-powered conversational ordering via Google Gemini.
   Tech Stack:
   ...
   Key features:
1. Integrated an AI-Powered Conversational Ordering Chatbot (FoodeeBot) using Google Gemini API to understand natural language and parse menu items.
