import { ChatOrderValidationService } from 'src/features/communications/chat/services/chat-order-validation.service';
import { ChatMetadata } from 'src/features/communications/chat/types/chat.types';
