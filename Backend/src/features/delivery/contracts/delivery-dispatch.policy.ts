...
/** Compatibility alias */
export const DELIVERY_ASSIGNMENT_POLICY = DELIVERY_DISPATCH_POLICY;
...
export class DeliveryDispatchPolicy {
...
/** Compatibility alias */
export const DeliveryAssignmentPolicy = DeliveryDispatchPolicy;
export type DeliveryAssignmentPolicy = DeliveryDispatchPolicy;
