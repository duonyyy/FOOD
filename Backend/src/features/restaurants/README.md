...
`MerchantCatalogService` và `RestaurantReaderService` được export qua public API của Restaurants.
Menu, Orders và feature khác phải dùng public API này, không dùng Restaurant repository.
