...
export class AddShipperPerformanceTracking1750000000018 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "averageDeliveryTime" float NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "onTimeDeliveries" integer NOT NULL DEFAULT 0`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "responseTimeMinutes" float NOT NULL DEFAULT 0`,
    );
