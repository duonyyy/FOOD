...
export class AddTenRestaurantsWithFoodsAndToppings1750000000024 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const restaurant1Foods = [
      [
        'Pizza Margherita',
        'Pizza Margherita truyền thống với cà chua San Marzano, mozzarella tươi và húng quế',
        180000,
        'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400',
      ],
      [
        'Pizza Pepperoni',
        'Pizza Pepperoni với xúc xích pepperoni cay nồng và phô mai mozzarella',
        220000,
        'https://images.unsplash.com/photo-1628840042765-356cda07504e?w=400',
      ],
      [
        'Pizza Quattro Stagioni',
        'Pizza bốn mùa với nấm, ham, artichoke và olive',
        250000,
        'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=400',
      ],
      [
        'Pizza Diavola',
        'Pizza cay với salami cay, ớt jalapeño và phô mai',
        240000,
        'https://images.unsplash.com/photo-1571407970349-bc81e7e96d47?w=400',
      ],
      [
        'Pizza Vegetarian',
        'Pizza chay với cà tím, zucchini, ớt chuông và pesto',
        200000,
    ...
    const restaurant2Foods = [
      [
        'Classic Beef Burger',
        'Burger bò Angus cổ điển với rau xanh, cà chua và sốt burger',
        150000,
        'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400',
      ],
      [
        'Cheese Burger Deluxe',
        'Burger phô mai cao cấp với thịt bò và 3 loại phô mai',
        180000,
        'https://images.unsplash.com/photo-1550547660-d9450f859349?w=400',
      ],
      [
        'Chicken Burger',
        'Burger gà chiên giòn với salad và sốt mayo',
        140000,
        'https://images.unsplash.com/photo-1606755962773-d324e9a13086?w=400',
      ],
      [
        'Fish Burger',
        'Burger cá hồi nướng với rau xanh và sốt tartar',
        160000,
        'https://images.unsplash.com/photo-1553909489-cd47e0ef937f?w=400',
      ],
      [
        'Veggie Burger',
        'Burger chay với patty từ đậu và rau củ',
        130000,
    ...
    const restaurant3Foods = [
      [
        'Sushi Combo A',
        'Combo sushi gồm 8 miếng sushi cá hồi, cá ngừ và tôm',
        280000,
        'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=400',
      ],
      [
        'Sashimi Premium',
        'Sashimi cao cấp với cá hồi, cá ngừ đại dương tươi',
        350000,
        'https://images.unsplash.com/photo-1617196034796-73dfa7b1fd56?w=400',
      ],
      [
        'Chirashi Bowl',
        'Cơm sashimi với nhiều loại cá tươi và rau củ',
        320000,
        'https://images.unsplash.com/photo-1582450871972-ab5ca1957163?w=400',
      ],
      [
        'Maki Set',
        'Set cuốn maki với cá hồi, cá ngừ và rau củ',
        250000,
        'https://images.unsplash.com/photo-1576675466766-f7e1c7e0a5d0?w=400',
      ],
      [
        'Tempura Udon',
        'Udon với tôm tempura và nước dashi đậm đà',
        180000,
    ...
    const restaurant4Foods = [
      [
        'Lẩu Tom Yum',
        'Lẩu Tom Yum cay nồng với tôm, nấm và lá chanh',
        380000,
        'https://images.unsplash.com/photo-1559847844-d90eb7b78f5c?w=400',
      ],
      [
        'Pad Thai',
        'Pad Thai truyền thống với tôm, trứng và đậu phộng',
        150000,
        'https://images.unsplash.com/photo-1559314809-0f31657d96c0?w=400',
      ],
      [
        'Som Tam',
        'Gỏi đu đủ Thái Lan cay chua với cà chua và đậu phộng',
        120000,
        'https://images.unsplash.com/photo-1562565652-a0d8f0c59eb4?w=400',
      ],
      [
        'Massaman Curry',
        'Cà ri Massaman với thịt bò và khoai tây',
        180000,
        'https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=400',
      ],
      [
        'Mango Sticky Rice',
        'Xôi xoài Thái Lan với nước cốt dừa',
        80000,
        'https://images.unsplash.com/photo-1561048103-1d4a9c8f3a1c?w=400',
      ],
    ];
    ...
    const restaurant5Foods = [
      [
        'Bulgogi Set',
        'Set thịt bò nướng Bulgogi với kimchi và cơm',
        280000,
        'https://images.unsplash.com/photo-1535473895227-bdab6e7bb930?w=400',
      ],
      [
        'Galbi BBQ',
        'Sườn bò nướng Galbi với sốt đặc biệt',
        350000,
        'https://images.unsplash.com/photo-1544025162-d76694265947?w=400',
      ],
      [
        'Bibimbap',
        'Cơm trộn Hàn Quốc với rau củ và thịt bò',
        160000,
        'https://images.unsplash.com/photo-1563379091339-03246963d21a?w=400',
      ],
      [
        'Kimchi Jjigae',
        'Canh kimchi với thịt heo và đậu phụ',
        140000,
        'https://images.unsplash.com/photo-1584503784915-46c2b3d1f8b4?w=400',
      ],
      [
        'Korean Fried Chicken',
        'Gà chiên Hàn Quốc với sốt cay ngọt',
        200000,
    ...
    const restaurant6Foods = [
      [
        'Har Gow',
        'Há cảo tôm trong vỏ bánh mỏng dai',
        120000,
        'https://images.unsplash.com/photo-1563379091339-03246963d21a?w=400',
      ],
      [
        'Siu Mai',
        'Siu mai thịt heo với trứng cút',
        100000,
        'https://images.unsplash.com/photo-1587073677146-36c2a6595d17?w=400',
      ],
      [
        'Char Siu Bao',
        'Bánh bao xá xíu nướng thơm ngon',
        90000,
        'https://images.unsplash.com/photo-1496116218417-1a781b1c416c?w=400',
      ],
      [
        'Cheung Fun',
        'Bánh cuốn phô mai và tôm',
        110000,
        'https://images.unsplash.com/photo-1587564171153-6b5e5e2e2ae5?w=400',
      ],
      [
        'Egg Tart',
        'Bánh tart trứng Hong Kong',
        60000,
        'https://images.unsplash.com/photo-1563379091339-03246963d21a?w=400',
      ],
    ];
    ...
    const restaurant7Foods = [
      [
        'Sichuan Hotpot',
        'Lẩu Tứ Xuyên cay nồng với nước lèo đặc biệt',
        420000,
        'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400',
      ],
      [
        'Tomato Hotpot',
        'Lẩu cà chua thanh mát với thịt bò và rau củ',
        380000,
        'https://images.unsplash.com/photo-1603137736717-f8b2d2b5a7e6?w=400',
      ],
      [
        'Mushroom Hotpot',
        'Lẩu nấm với nhiều loại nấm cao cấp',
        360000,
        'https://images.unsplash.com/photo-1585032226651-759b368d7246?w=400',
      ],
      [
        'Seafood Hotpot',
        'Lẩu hải sản với tôm, cua, mực tươi',
        480000,
        'https://images.unsplash.com/photo-1544025162-d76694265947?w=400',
      ],
      [
        'Vegetarian Hotpot',
        'Lẩu chay với đậu phụ và rau củ',
        280000,
    ...
    const restaurant9Foods = [
      [
        'Beef Tacos',
        'Taco thịt bò với rau xanh và sốt salsa',
        140000,
        'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=400',
      ],
      [
        'Chicken Quesadilla',
        'Quesadilla gà với phô mai và ớt jalapeño',
        160000,
        'https://images.unsplash.com/photo-1565299585323-38174c4a6663?w=400',
      ],
      [
        'Fish Tacos',
        'Taco cá với bắp cải và sốt chipotle',
        150000,
        'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=400',
      ],
      [
        'Burrito Bowl',
        'Burrito bowl với thịt bò, gạo và đậu đen',
        180000,
        'https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=400',
      ],
      [
        'Nachos Supreme',
        'Nachos với phô mai, thịt bò và guacamole',
        120000,
    ...
    const restaurant10Foods = [
      [
        'Caesar Salad',
        'Salad Caesar với gà nướng và phô mai Parmesan',
        140000,
        'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400',
      ],
      [
        'Greek Salad',
        'Salad Hy Lạp với phô mai feta và olive',
        130000,
        'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400',
      ],
      [
        'Quinoa Power Bowl',
        'Bowl quinoa với avocado và rau củ',
        160000,
        'https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400',
      ],
      [
        'Salmon Salad',
        'Salad cá hồi nướng với rau xanh',
        220000,
        'https://images.unsplash.com/photo-1559847844-d90eb7b78f5c?w=400',
      ],
      [
        'Vegan Buddha Bowl',
        'Buddha bowl chay với nhiều loại rau củ',
        150000,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DELETE FROM "toppings" WHERE id IN (${this.newToppingIds.map((_, i) => `$${i + 1}`).join(', ')})`,
      this.newToppingIds,
    );
    await queryRunner.query(
      `DELETE FROM "foods" WHERE id IN (${this.newFoodIds.map((_, i) => `$${i + 1}`).join(', ')})`,
      this.newFoodIds,
    );
    await queryRunner.query(
      `DELETE FROM "restaurants" WHERE id IN (${this.newRestaurantIds.map((_, i) => `$${i + 1}`).join(', ')})`,
      this.newRestaurantIds,
    );
    await queryRunner.query(
      `DELETE FROM "users" WHERE id IN (${this.newUserIds.map((_, i) => `$${i + 1}`).join(', ')})`,
      this.newUserIds,
    );
    await queryRunner.query(
